...
#[derive(Debug, Clone)]
pub struct RangeCheckConfig<F: FieldExt, const RANGE: usize, const LOOKUP_RANGE: usize> {
    value: Column<Advice>,
...
pub struct TestCircuit<F: FieldExt, const RANGE: usize, const LOOKUP_RANGE: usize> {
    pub value: Value<F>,
    pub larger_value: Value<F>,
}

impl<F: FieldExt, const RANGE: usize, const LOOKUP_RANGE: usize> Circuit<F>
    for TestCircuit<F, RANGE, LOOKUP_RANGE>
{
...
mod tests {
    ...
    fn test_range_check() {
        ...
        // Successful cases
        for i in 0..RANGE {
            let circuit = TestCircuit::<Fp, RANGE, LOOKUP_RANGE> {
